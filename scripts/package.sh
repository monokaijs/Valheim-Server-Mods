...
mkdir -p "$package_root/BepInEx/patchers" "$package_root/BepInEx/plugins/ServerModBootstrap" "$artifact_root"
...
cp "$project_root/src/XomNghien.RuntimeUpdater/bin/Release/net472/XomNghienRuntimeUpdater.dll" "$package_root/BepInEx/plugins/ServerModBootstrap/XomNghienRuntimeUpdater.dll"
sips -z 256 256 "$project_root/../xom-nghien-web/apps/web/public/favicon.png" --out "$package_root/icon.png" >/dev/null

artifact="$artifact_root/XomNghien-ServerModBootstrap-$version.zip"
rm -f "$artifact"
